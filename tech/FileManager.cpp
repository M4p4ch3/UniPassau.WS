...
class FileManager
{
    ...
    static int write(std::string fileName, std::vector<double> speeds, std::vector<double> elevationGradients, std::vector<double> heartRates, bool isOverTraining)
    {
        int result = 1;
        ...
        if (myFile.is_open())
        {
            ...
            myFile << "overTraining:'" << isOverTraining << "'\n";
    ...
    static int write(std::string fileName, Stats speedsStates, Stats elevationGradientsStats, Stats heartRatesStats, bool isOverTraining)
    {
        int result = 1;
    ...
    static int append(std::string fileName, Stats speedsStates, Stats elevationGradientsStats, Stats heartRatesStats, bool isOverTraining)
    {
        int result = 1;
